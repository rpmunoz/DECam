pro worker_sky_median_running, chip, chip_name, im_size, chip_offset, chip_n, im_file, im_name, sky_file, sky_name, mask_file, mask_name, im_filter, program, out_im, out_sky
	...
	out_im = im_data - rebin([replicate(im_median[0],im_size[0]/2),replicate(im_median[1],im_size[0]/2)], im_size) * out_sky
